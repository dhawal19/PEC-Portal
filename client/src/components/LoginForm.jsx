      ...
      <form action='' onSubmit={handleLogin}>
        ...
        <div className="flex items-center mt-4 mb-4">
          ...
          <button
            ...
            <button
              className="google-button flex items-center justify-center bg-blue-500 hover:bg-green-700 text-white py-2 px-3 rounded-3xl w-full focus:outline-none focus:shadow-outline hover:scale-105 duration-300"
              type="button"
            >
